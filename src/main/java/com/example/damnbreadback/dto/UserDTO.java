...
public class UserDTO {
    ...
    private String nickname; // 닉네임 - 수정가능
    private String id; // 아이디
    private String pw; // 비밀번호 - 수정 가능
    private String email; // 이메일 - 수정가능
    private String phone; // 전화번호 - 수정가능
    private String home; // 거주지 -> string 으로 (private String location)- 수정가능
    private Date birth; // 생년월일
    private boolean gender; // 성별 (true : 남자 , false : 여자)
    private String introduce; //소개글 - 수정가능
    private String badge; //뱃지 ex. "00000000", "00010000"
    private int noShow; // 노쇼 횟수
    private int score; // 점수
    private String hopeJob; // 희망 업/직종 - 수정가능
